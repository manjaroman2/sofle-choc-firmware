...
const USB_Descriptor_HIDReport_Datatype_t PROGMEM GenericReport[] = {
    ...
    HID_RI_REPORT_COUNT(8, GENERIC_EPSIZE),
...
const USB_Descriptor_Configuration_t PROGMEM ConfigurationDescriptor = {
    ...
    .HID2_Interface  = {.Header = {.Size = sizeof(USB_Descriptor_Interface_t), .Type = DTYPE_Interface},
                        ...
                        .InterfaceStrIndex = NO_DESCRIPTOR},
    .HID2_GenericHID = {.Header = {.Size = sizeof(USB_HID_Descriptor_HID_t), .Type = HID_DTYPE_HID},
    ...
    .HID2_ReportINEndpoint = {.Header = {.Size = sizeof(USB_Descriptor_Endpoint_t), .Type = DTYPE_Endpoint},
