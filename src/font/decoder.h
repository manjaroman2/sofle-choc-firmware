...
uint8_t st_read_bits_u8_msbl(uint8_t** out, uint8_t* out_offs, uint8_t n);
...
uint8_t st_copy_pattern_bits(uint8_t** outbuf, uint8_t* outbuf_bit_offs, const uint8_t* pat_buf, uint8_t pat_len, uint8_t pat_nbits, uint8_t reps);
